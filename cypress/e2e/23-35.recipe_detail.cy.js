...
describe('23 - Realize uma request para a API passando o `id` da receita que deve estar disponível nos parâmetros da URL', () => {
...
describe('24 - Desenvolva a tela de modo que contenha uma imagem da receita, o título, a categoria em caso de comidas e se é ou não alcoólico em caso de bebidas, uma lista de ingredientes seguidos pelas quantidades, instruções, um vídeo do youtube incorporado e recomendações', () => {
...
describe('25 - Implemente as recomendações. Para receitas de comida, a recomendação deverá ser bebida, já para as receitas de bebida a recomendação deverá ser comida', () => {
  it('Verifica se a requisição para a API de bebidas foi realizada', () => {
    cy.visit('http://localhost:3000/meals/52771', {
      onBeforeLoad(win) {
        cy.spy(win, 'fetch');
...
describe('26 - Implemente os 6 cards de recomendação, mostrando apenas 2. O scroll é horizontal, similar a um `carousel`', () => {
...
describe('27 - Desenvolva um botão de nome \"Start Recipe\" que deve ficar fixo na parte de baixo da tela o tempo todo', () => {
...
describe('28 - Implemente a solução de forma que, caso a receita já tenha sido feita, o botão \"Start Recipe\" desapareça', () => {
...
describe('29 - Implemente a solução de modo que, caso a receita tenha sido iniciada mas não finalizada, o texto do botão deve ser \"Continue Recipe\"', () => {
...
describe('30 - Redirecione a pessoa usuária caso o botão \"Start Recipe\" seja clicado, a rota deve mudar para a tela de receita em progresso', () => {
...
describe('31 - Implemente um botão de compartilhar e um de favoritar a receita', () => {
...
describe('32 - Implemente a solução de forma que, ao clicar no botão de compartilhar, o link da receita dentro do app deve ser copiado para o clipboard e uma mensagem avisando que o link foi copiado deve aparecer', () => {
...
describe('33 - Salve as receitas favoritas no `localStorage` na chave `favoriteRecipes`', () => {
...
describe('34 - Implemente o ícone do coração (favorito) de modo que: deve vir preenchido caso a receita esteja favoritada e \"despreenchido\" caso contrário', () => {
...
describe('35 - Implemente a lógica no botão de favoritar. Caso seja clicado, o ícone do coração deve mudar seu estado atual, caso esteja preenchido deve mudar para \"despreenchido\" e vice-versa', () => {
