...
<details>
  ...
  * Data para entrega final do projeto: `21/05/2024 23:59`.
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH39&template=betrybe/sd-0x-project-recipes-app-ts)
...
<br /><details>
  ...
  * Caso apenas uma comida seja encontrada, deve-se ir para sua rota de detalhes (`/meals/:id`).
  * Caso apenas uma bebida seja encontrada, deve-se ir para sua rota de detalhes (`/drinks/:id`).
</details>
...
<br /><details>
  ...
  * Caso a receita seja de uma comida, a pessoa deve ser redirecionada para a rota `/meals/:id`.
  * Caso a receita seja de uma bebida, a pessoa deve ser redirecionada para a rota `/drinks/:id`.
</details>
...
> - 🔗 As rotas usadas para essa tela devem ser `/meals/:id` e `/drinks/:id`.
...
> - 🔗 As rotas usadas para essa tela devem ser `/meals/:id/in-progress` e `/drinks/:id/in-progress`.
